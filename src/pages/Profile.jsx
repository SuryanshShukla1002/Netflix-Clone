...
const Profile = () => {
  ...
  return (
    ...
    <div>
      <div>
        <img className='block w-full h-[500px] object-cover' src="https://assets.nflxext.com/ffe/siteui/vlv3/a99688ca-33c3-4099-9baa-07a2e2acb398/ca15fd28-b624-4852-8bfe-9cdd5c88475d/IN-en-20240520-popsignuptwoweeks-perspective_alpha_website_small.jpg" alt="//" />
...
<div className="absolute top-0 left-0 w-full h-40 bg-black/80 opacity-0 hover:opacity-100">
  ...
  <p>
    <AiOutlineClose size={30} onClick={() => handleLikeShow(movie)} className='absolute top-2 right-2'/>
  </p>
